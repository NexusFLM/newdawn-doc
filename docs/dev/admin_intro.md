...
- weight : *(Valeur Optionnelle)* Le poids d'une unité de l'item. *Cette valeur est en grammes*
- stack : *(Valeur Optionnelle)* Est-ce que l'item est empilable. On la défini avec : **true** ou **false**
